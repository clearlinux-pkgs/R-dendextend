...
Version  : 1.8.0
Release  : 12
URL      : https://cran.r-project.org/src/contrib/dendextend_1.8.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/dendextend_1.8.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1525356786
